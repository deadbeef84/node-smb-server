...
const DefaultAuthenticator = require('./defaultauthenticator')
const ntlm = require('./ntlm')
const SMBConnection = require('./smbconnection')
const SMBLogin = require('./smblogin')
const SMBSession = require('./smbsession')
const SMBShare = require('./smbshare')
const IPCShare = require('./backends/ipc/share')
...
function SMBServer(config, authenticator) {
  ...
  _.forEach(config.shares, function (shareCfg, name) {
    ...
    const Share = require('./backends/' + type + '/share')
 ...
 */
SMBServer.prototype.setupSession = function (
  login,
  accountName,
  primaryDomain,
