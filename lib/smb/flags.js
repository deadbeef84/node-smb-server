...
function encode(flgs) {
  ...
  ret.flags =
    ...
    (flgs.pathnames && flgs.pathnames.canonical
      ? consts.FLAGS_CANONICAL_PATHNAMES
      : 0) |
    (flgs.pathnames && flgs.pathnames.caseless
      ? consts.FLAGS_CASELESS_PATHNAMES
      : 0) |
  ...
  ret.flags2 =
    ...
    (flgs.security && flgs.security.extended
      ? consts.FLAGS2_EXTENDED_SECURITY
      : 0) |
    (flgs.security && flgs.security.signature && flgs.security.signature.enabled
      ? consts.FLAGS2_SECURITY_SIGNATURE
      : 0) |
    (flgs.security &&
    flgs.security.signature &&
    flgs.security.signature.required
