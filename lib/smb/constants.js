...
consts.IS_ANDX_COMMAND = function (cmdId) {
  return (
    consts.COMMAND_TO_STRING[cmdId] &&
    consts.COMMAND_TO_STRING[cmdId].substr(-5) === '_andx'
  );
};
...
consts.STRING_TO_TRANS2_SUBCOMMAND = _.invert(
  consts.TRANS2_SUBCOMMAND_TO_STRING
);
...
consts.STRING_TO_NTTRANS_SUBCOMMAND = _.invert(
  consts.NTTRANS_SUBCOMMAND_TO_STRING
);
...
consts.TREE_ACCESS_ALL =
  consts.FILE_LIST_DIRECTORY |
  consts.FILE_ADD_FILE |
  consts.FILE_ADD_SUBDIRECTORY |
  consts.FILE_READ_EA |
  consts.FILE_WRITE_EA |
  consts.FILE_TRAVERSE |
  consts.FILE_DELETE_CHILD |
  consts.FILE_READ_ATTRIBUTES |
  consts.FILE_WRITE_ATTRIBUTES;
consts.TREE_ACCESS_READONLY =
  consts.FILE_LIST_DIRECTORY |
  consts.FILE_READ_EA |
  consts.FILE_TRAVERSE |
  consts.FILE_READ_ATTRIBUTES;
