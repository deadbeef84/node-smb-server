...
var FIND_FILE_ID_FULL_DIRECTORY_INFO_SIZE =
  FIND_FILE_FULL_DIRECTORY_INFO_SIZE + 8;

// Size of <code>FIND_FILE_ID_BOTH_DIRECTORY_INFO_SIZE</code> (without file name).
var FIND_FILE_ID_BOTH_DIRECTORY_INFO_SIZE =
  FIND_FILE_BOTH_DIRECTORY_INFO_SIZE + 2 + 8;
    ...
    switch (informationLevel) {
      ...
      case SMB.FIND_FILE_DIRECTORY_INFO:
        out.word32le(
          index === files.length - 1
            ? 0
            : FIND_FILE_DIRECTORY_INFO_SIZE + fileNameBytes.length
        ); // NextEntryOffset
      ...
      case SMB.FIND_FILE_FULL_DIRECTORY_INFO:
        out.word32le(
          index === files.length - 1
            ? 0
            : FIND_FILE_FULL_DIRECTORY_INFO_SIZE + fileNameBytes.length
        ); // NextEntryOffset
        out.word32le(index + start); // FileIndex
        lastNameOffset = out.length();
        out
      ...
      case SMB.FIND_FILE_NAMES_INFO:
        out.word32le(
          index === files.length - 1
            ? 0
            : FIND_FILE_NAMES_INFO_SIZE + fileNameBytes.length
        ); // NextEntryOffset
        out.word32le(index + start); // FileIndex
        lastNameOffset = out.length();
        out
      ...
      case SMB.FIND_FILE_BOTH_DIRECTORY_INFO:
        out.word32le(
          index === files.length - 1
            ? 0
            : FIND_FILE_BOTH_DIRECTORY_INFO_SIZE + fileNameBytes.length
        ); // NextEntryOffset
        out.word32le(index + start); // FileIndex
        lastNameOffset = out.length();
        out
