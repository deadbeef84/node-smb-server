...
const defaultSecurityBuffer = [
  0x60, 0x48, 0x06, 0x06, 0x2b, 0x06, 0x01, 0x05, 0x05, 0x02, 0xa0, 0x3e, 0x30,
  0x3c, 0xa0, 0x0e, 0x30, 0x0c, 0x06, 0x0a, 0x2b, 0x06, 0x01, 0x04, 0x01, 0x82,
  0x37, 0x02, 0x02, 0x0a, 0xa3, 0x2a, 0x30, 0x28, 0xa0, 0x26, 0x1b, 0x24, 0x6e,
  0x6f, 0x74, 0x5f, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x5f, 0x69, 0x6e,
  0x5f, 0x52, 0x46, 0x43, 0x34, 0x31, 0x37, 0x38, 0x40, 0x70, 0x6c, 0x65, 0x61,
...
function handle(msg, commandId, body, related, connection, server, cb) {
  ...
  var securityBuffer = Buffer.from(defaultSecurityBuffer);
  var out = put();
  out
    .word16le(0x0041) // StructureSize (fixed according to spec)
    .word16le(1) // SecurityMode
    ...
    .put(Buffer.concat([
      ...
      Buffer.from('01002600000000000100200001001fc8040723b018a22509a84d9d6936475e18402583d6567efc004535ef9a2ddc', 'hex'),
      Buffer.alloc(2, 0),
