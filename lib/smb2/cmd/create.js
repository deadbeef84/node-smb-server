...
import { CreateDisposition, CreateOptions, DirectoryAccessMask, FileAttributes, ImpersonationLevel, ShareAccess } from '../../enum.js'
...
export default async function handle(msg, related, connection, server) {
  ...
  logger.debug({
    ...
    createOptions: utils.enumToStr(req.createOptions, CreateOptions),
  }, 'CREATE')
