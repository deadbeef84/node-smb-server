...
const Authenticator = require('./spi/authenticator')
const Session = require('./spi/session')
 ...
 * @this {DefaultSession}
 */
const DefaultSession = function (accountName, domainName) {
 ...
 */
const DefaultAuthenticator = function (config) {
...
DefaultAuthenticator.prototype.authenticate = function (
  challenge,
